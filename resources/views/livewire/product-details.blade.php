                    ...
                    <div class="product-detail accordion-detail">
                        ...
                        @auth
                            <form action="{{ route('comments.store', $product->id) }}" method="POST">
                                @csrf
                                <textarea name="comment" rows="4" placeholder="Izoh yozing..." required></textarea>
                                <button type="submit">Yuborish</button>
                            </form>
                        @else
                            <p>Kommentariya qoldirish uchun <a href="{{ route('login') }}">kiring</a> yoki <a href="{{ route('register') }}">ro'yxatdan o'ting</a>.</p>
                        @endauth
                    </div>
                </div>
    </section>
